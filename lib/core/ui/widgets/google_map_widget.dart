...
class MapWidget extends StatefulWidget {
  ...
  const MapWidget({super.key, this.myLocation, this.markers, this.onMapCreated,this.newLatLng});
...
class _MapWidgetState extends State<MapWidget> {
  ...
  bool myLocationSet = false;
   ...
   //          CameraPosition(target: widget.newLatLng!, zoom: 17)
   //      ));
   //  }
  ...
  void _setMyLocation() {
    ...
    if (!isInitialized && !myLocationSet && widget.myLocation != null) {
      BlocProvider.of<MapsCubit>(context).controller.moveCamera(CameraUpdate.newLatLng(
          widget.myLocation!
          ));
      myLocationSet = true;
    }
