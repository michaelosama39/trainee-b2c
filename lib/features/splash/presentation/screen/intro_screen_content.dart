...
class _IntroScreenContentState extends State<IntroScreenContent> {
  ...
  void _onSkipPressed() {
    setState(() {
      _currentPageInt = _maxPages - 1;
    });
    _pageController.animateToPage(_currentPageInt,
        duration: const Duration(milliseconds: 1), curve: Curves.linear);
  }

  void _onSkipAllPressed() {
      ...
      children: [
        PageView(
          ...
          onPageChanged: (v) {
            ...
            print('_currentPageInt: $_currentPageInt');
            print('_maxPages: $_maxPages');
            print(_currentPageInt == _maxPages - 1);
            print('=====================');
          },
          children: [
            _buildIntroPageView(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Padding(
                ...
                child: _currentPageInt == _maxPages - 1
                    ? CustomElevatedButton(
                        onTap: _onSkipAllPressed,
