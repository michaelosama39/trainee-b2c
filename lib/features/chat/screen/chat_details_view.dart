...
import 'package:upgrade_traine_project/features/chat/screen/video_call_screen.dart';
import 'package:upgrade_traine_project/features/chat/screen/video_screen.dart';
import 'package:upgrade_traine_project/features/chat/screen/voice_call_screen.dart';
          ...
          Expanded(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                image:
                widget.chatModel!.traineeImage==null?const DecorationImage(
                  image:
                ...
                DecorationImage(
                  fit: BoxFit.cover,
                  image: NetworkImage(widget.chatModel!.trainerImage ?? ""),
                ),
              ),
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                ZegoSendCallInvitationButton(
                  ...
                  invitees: [
                    ZegoUIKitUser(
                      id: widget.chatModel!.trainerId.toString(),
                      name: widget.chatModel!.trainerName!,
                    ),
                  ],
                ),
                Padding(
