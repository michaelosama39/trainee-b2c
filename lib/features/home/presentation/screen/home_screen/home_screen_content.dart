...
import '../../../../restaurant/domain/entity/restaurants_entity.dart';
                  ...
                  builder: (context, state) {
                    return state.when(
                      ...
                      getCategoriesState: (categoriesEntity) {
                        ...
                        return
                            // Container(height: 50,color: Colors.re,);
                            SizedBox(
                          width: 1.sw,
                          height: 0.38.sh,
                    ...
                    return state.when(
                      ...
                      getShopsState: (shopsEntity) {
                        ...
                        return SizedBox(
                          ...
                          child: _buildSectionWidget(
                            title:
                                Translation.of(context).food_supplements,
                            widgets: categories0,
