...
import '../model/request/create_feedback_request.dart';
...
class AccountRemoteSource extends IAccountRemoteSource {
  ...
  @override
  Future<Either<AppErrors, AcknowledgeModel>> createFeedback(CraeteFeedbackRequest params) async {
    return await request<AcknowledgeModel>(
      converter: (json) => AcknowledgeModel.fromJson(json),
      method: HttpMethod.POST,
      url: APIUrls.API_create_Report,
      body: params.toMap(),
    );
  }
}
