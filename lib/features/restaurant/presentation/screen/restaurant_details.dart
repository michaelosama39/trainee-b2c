...
import 'package:upgrade_traine_project/features/restaurant/presentation/screen/all_plates_screen.dart';
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            CustomText(
                              text:
                                  Translation.of(context).whats_ur_rating,
                            ...
                            CustomText(
                              text:
                                  Translation.of(context).whats_ur_opinion,
                              fontSize: AppConstants.textSize16,
                            ),
                            Gaps.vGap8,
                            Container(
                ...
                children: [
                  Padding(
                    ...
                    child: TitleWidget(
                      ...
                      subtitleColorTapped: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=> AllPlatesScreen(listPlatesModel: state.platesModel!.result!.items!)));
                      },
                    ),
                  ),
                  Gaps.vGap16,
