                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: RestaurantAndShopsCardShow(
                        ...
                        coverImage: BlocProvider.of<RestaurantCubit>(context)
                            .restaurants!
                            .items![index]
                            .cover
                            .toString(),
                        title: BlocProvider.of<RestaurantCubit>(context)
                            .restaurants!
                            .items![index]
                            .arName
                            .toString(),
                        body: BlocProvider.of<RestaurantCubit>(context)
                            .restaurants!
                            .items![index]
                            .arDescription
                            .toString(),
                        avatarImage: BlocProvider.of<RestaurantCubit>(context)
                            .restaurants!
                            .items![index]
                            .logo
                            .toString(),
